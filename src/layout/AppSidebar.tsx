    ...
    >
      <div className={`py-8 flex ${!isExpanded && !isHovered ? "lg:justify-center" : "justify-start"}`}>
        <Link to="/" className="flex items-center gap-3">
          <img src="/logo.png" alt="ezwa & sanad" className="h-10 w-10" />
          {(isExpanded || isHovered || isMobileOpen) && <span className="text-lg font-semibold text-gray-900 dark:text-white">ezwa &amp; sanad</span>}
        </Link>
      </div>
