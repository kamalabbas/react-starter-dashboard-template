...
const ConfigurationFamilyBranches: React.FC = () => {
  const { data, isLoading } = useGetFamilyBranches("LB");
  ...
  const columns: Column<FamilyBranchItem>[] = [
    ...
    },
    {
      ...
      header: "Order",
      render: (b) => (
        <span className="text-gray-600 dark:text-gray-300">{b.orderId}</span>
      ),
    },
    {
      key: "status",
  ...
  <div className="w-full max-w-md mx-auto rounded-xl bg-white dark:bg-slate-900 shadow-xl border border-gray-200 dark:border-slate-700">
